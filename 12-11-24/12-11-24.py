...
class animal:
    def __init__(self):
        self.name = input("Enter name of the Animal Here : ")
        self.breed = input("Enter breed Animal Breed Here :  ")
        self.color = input("Enter color of the Animal Here : ")
