...
if is_value_present(my_dict, value_to_check):
    print(f"The value {value_to_check} is present in the dictionary.")
else:
    print(f"The value {value_to_check} is not present in the dictionary.")
